                ...
                <div class="card-body">
                    ...
                    <?php 
                        if(isset($model['image']) && !empty($model['image'])) {
                            $path = WRITEPATH . '/uploads/blogs/' . $model['id'] . '/' . $model['image'];
                            if (file_exists($path)) {
                                echo '<div class="form-group"><a target="_blank" href="'.base_url().'/writable/uploads/blogs/'.$model['id'].'/'.$model['image'].'">View File</a></div>';
                            }
                        } 
                    ?>
