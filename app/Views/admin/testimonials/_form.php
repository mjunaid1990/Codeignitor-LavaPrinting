            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="designation" value="<?php echo isset($model['designation'])?$model['designation']:'' ?>" class="form-control" />
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label" for="designation">Description</label>
                    ...
                    <?php 
                        if(isset($model['image']) && !empty($model['image'])) {
                            $path = WRITEPATH . '/uploads/testimonials/' . $model['id'] . '/' . $model['image'];
                            if (file_exists($path)) {
                                echo '<div class="form-group"><a target="_blank" href="'.base_url().'/writable/uploads/testimonials/'.$model['id'].'/'.$model['image'].'">View File</a></div>';
                            }
                        } 
                    ?>
